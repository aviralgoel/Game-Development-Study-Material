...
# Unity Material
1. [Understanding Mesh Anatomy in Unity](https://medium.com/shader-coding-in-unity-from-a-to-z/understanding-mesh-anatomy-in-unity-2507cb1ae011)
2. [What Are Sprites And How They Work In Games?](https://gamingshift.com/sprites-in-games/)
3. [Sprite Scaling and the Sega 32X](https://www.youtube.com/watch?v=Pfw5cL4ExlU)
4. [Order of execution for Unity event functions](https://docs.unity3d.com/Manual/ExecutionOrder.html)
5. [How to use Fixed Update in Unity](https://gamedevbeginner.com/how-to-use-fixed-update-in-unity/)
